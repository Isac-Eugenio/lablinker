...
* 🧠 **Interface intuitiva e adaptável** – experiência fluida em diferentes telas e dispositivos Android.
* 📡 **Conexão com Node-RED e ESP32** – controle e monitoramento direto de projetos IoT.
* 💾 **Integração com banco de dados** – suporte para MongoDB e conexões remotas.
* 📱 **Dashboard Maker** – componentes interativos como botões, gráficos e status dinâmicos.
* 🔗 **Comunicação full-duplex** – envio e recebimento contínuo de dados com o servidor.
* 🧰 **Modo Desenvolvedor** – voltado para makers que desejam integrar seus próprios módulos.
...
| Backend / API  | HTTP, MQTT, Bluetooth      |
...
* 🔔 Sistema de notificações e alertas por evento
* 👥 Controle de usuários com níveis de permissão
* 🧱 Módulos educativos sobre automação e IoT
